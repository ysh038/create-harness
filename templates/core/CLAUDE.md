...
- 워크플로는 `.claude/skills/` 의 spec / impl / verify / ship / qa / design-system 스킬로 제공된다.
- `/qa` 는 `.claude/agents/qa-tester.md` 서브에이전트에게 맡긴다. 넘기는 것은 목적·주소·사용자 유형·테스트 계정뿐이다 — 코드 힌트를 주지 않는다.
